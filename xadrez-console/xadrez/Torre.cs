...
namespace xadrez {
    internal class Torre : Peca { // Essa classe é uma subclasse da classe Peca, portanto a Torre é uma Peça
        ...
        public override bool[,] movimentosPossiveis() {
            // Método que retorna uma matriz booleana de todos o movimentos possíveis para a Torre
